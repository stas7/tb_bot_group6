...
class MeetingCreationAddressState : StateInterface{
    ...
    override fun getAnswer(stateInfoDTO: StateInfoDTO): SendMessage {
        ...
        return SendMessage(stateInfoDTO.chatId.toString(), "Введите время и дату в формате dd.MM.yyyy HH:mm")
    }
    ...
    override fun changeState(stateInfoDTO: StateInfoDTO) {
        ...
        customer.state = MachinesStateEnum.MEETING_CREATION_DATETIME
